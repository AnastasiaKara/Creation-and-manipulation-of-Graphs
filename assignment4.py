...
def new_connections_predictions():
    ...
    adamic = [item[2] for item in list(nx.adamic_adar_index(G, ebunch=future_connections.index))]
    ...
    X_test_scaled = scaler.transform(X_test)
    #creating the model
    model = MLPClassifier(hidden_layer_sizes = [10, 5], alpha = 5, random_state = 0, solver='lbfgs', verbose=0)
